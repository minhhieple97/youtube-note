    ...
    <div className="note-editor">
      <div className="editor-header">
        ...
        <div className="editor-actions">
          ...
          <button className="editor-action-btn cancel-btn" onClick={onCancel} title="Cancel (Esc)">
            <X size={16} />
          </button>
        </div>
      </div>
      ...
      <div className="editor-formatting">
        <button className="format-btn bold-btn" title="Bold (Ctrl+B)">
          B
        </button>
        <button className="format-btn italic-btn" title="Italic (Ctrl+I)">
          I
        </button>
        <button className="format-btn underline-btn" title="Underline (Ctrl+U)">
          U
        </button>
        <button className="format-btn list-btn" title="Bullet List">
          •
        </button>
      </div>
